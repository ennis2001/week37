...
/* Task C.1: Variable for gravity (using standard units: m/s² */
const gravity = 9.8;

/* Task C.2: Variable for Pi (π) */
const pi = 3.14159265359;

/* Variable for people currently in the room (uses let since it may change) */
let peopleInRoom = 1;

console.log("Earth's gravity:", gravity);
console.log("Pi:", pi);
...
const phoneNumbers = ["+47 37233464", "+47 41459930", "+47 37233426", "+47 37233379", "+47 41628634"];
...
for (let index = 0; index < peopleNames.length; index++) {
    const fullName = peopleNames[index];
